...
int main() {
  ...
  Pathway road_map = Pathway(map_waypoints_x, map_waypoints_y, map_waypoints_s);
  Plan planner = Plan(road_map);
  // road_map.InitSpline();

  // h.onMessage([&map_waypoints_x,&map_waypoints_y,&map_waypoints_s,&map_waypoints_dx,&map_waypoints_dy](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
  //                    uWS::OpCode opCode) {
  h.onMessage([&road_map, &planner](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length, uWS::OpCode opCode) {
